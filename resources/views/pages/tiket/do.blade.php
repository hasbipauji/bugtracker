            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <span role="button" class="text-primary d-none" onclick="modalUrlPengembangan()" id="detail_ubah_url_pengembangan">Ubah</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        columns: [
            ...
            },
            {
                ...
                render: (data, type, row) =>
                {
                    ...
                    if( row.status == 'PROSES' || row.status == 'REVISI' )
                    {
                        buttons += `<button class='btn btn-sm btn-primary mt-2 w-100' onClick='serahkan(${row.id})'>Serahkan</button>`;
                    }
    ...
    const getDetail = () => 
    {
        ...
        $.ajax({
            ...
            success: (response) =>
            {
                ...
                {
                    $('#detail_ubah_url_pengembangan').addClass('d-none');
                }
                else
                {
                    $('#detail_ubah_url_pengembangan').removeClass('d-none');
                }
            }
        })
    }
