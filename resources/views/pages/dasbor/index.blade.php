    ...
    <div class="col-6 col-sm-3">
        <div class="card shadow-none">
            <div class="card-body bg-primary text-white d-flex">
                ...
                <div>
                    <span class="d-block">Tester</span>
                    <span class="fs-5">{{ $jumlah_tester }} Orang</span>
                </div>
            </div>
        </div>
    </div>
        ...
        columns: [
            ...
            },
            {
                ...
                render: (data, type, row) => 
                {
                    ...
                    return `<a href='../../tiket/${row.tr_tiket_id}' class='${warna}'>Detail</a>`
                }
            },
        ]
    });
